      ...
      <div className="max-w-7xl mx-auto">
        ...
        >
          ...
          <motion.div {...hoverProps} className="bento-animate bento-item lg:col-span-7 relative group overflow-hidden">
            <img src={featureDigitise} alt="Digitise your wardrobe" className="absolute inset-0 w-full h-full object-cover opacity-20 group-hover:opacity-30 transition-opacity duration-700" />
          ...
          <motion.div {...hoverProps} className="bento-animate bento-item lg:col-span-5 relative group overflow-hidden">
            <img src={featureOutfits} alt="Daily outfit recommendations" className="absolute inset-0 w-full h-full object-cover opacity-20 group-hover:opacity-30 transition-opacity duration-700" />
            <div className="relative z-10 h-full flex flex-col justify-between">
              <div className="flex items-center gap-3">
                <div className="w-10 h-10 rounded-full bg-secondary flex items-center justify-center">
          ...
          <motion.div {...hoverProps} className="bento-animate bento-item lg:col-span-5 relative group overflow-hidden">
            <img src={featurePlanner} alt="Smart trip planning" className="absolute inset-0 w-full h-full object-cover opacity-20 group-hover:opacity-30 transition-opacity duration-700" />
            <div className="relative z-10 h-full flex flex-col justify-between">
              <div className="flex items-center gap-3">
                <div className="w-10 h-10 rounded-full bg-secondary flex items-center justify-center">
          ...
          <motion.div {...hoverProps} className="bento-animate bento-item lg:col-span-4 relative group overflow-hidden">
            <img src={featureShopping} alt="Shopping assistance" className="absolute inset-0 w-full h-full object-cover opacity-15 group-hover:opacity-25 transition-opacity duration-700" />
            <div className="relative z-10 h-full flex flex-col justify-between">
              <div className="flex items-center gap-3">
                <div className="w-10 h-10 rounded-full bg-secondary flex items-center justify-center">
          ...
          <motion.div {...hoverProps} className="bento-animate bento-item lg:col-span-3 relative group overflow-hidden">
            <img src={featureWishlist} alt="Wishlists and price tracking" className="absolute inset-0 w-full h-full object-cover opacity-20 group-hover:opacity-30 transition-opacity duration-700" />
            <div className="relative z-10 h-full flex flex-col justify-between">
              <div className="w-10 h-10 rounded-full bg-secondary flex items-center justify-center">
              ...
              <div>
                ...
                <p className="text-sm text-muted-foreground">
                  Save items and get notified when prices drop.
                </p>
              </div>
            </div>
          </motion.div>
          ...
          {/* 6. Wardrobe Insights */}
          <motion.div {...hoverProps} className="bento-animate bento-item lg:col-span-4 relative group overflow-hidden">
            <img src={featureInsights} alt="Wardrobe insights" className="absolute inset-0 w-full h-full object-cover opacity-20 group-hover:opacity-30 transition-opacity duration-700" />
            <div className="relative z-10 h-full flex flex-col justify-between">
              <div className="flex items-center gap-3">
                <div className="w-10 h-10 rounded-full bg-secondary flex items-center justify-center">
          ...
          {/* 7. Pro Styling */}
          <motion.div {...hoverProps} className="bento-animate bento-item lg:col-span-3 relative group overflow-hidden">
            <img src={featureStyling} alt="Pro styling" className="absolute inset-0 w-full h-full object-cover opacity-20 group-hover:opacity-30 transition-opacity duration-700" />
            <div className="relative z-10 h-full flex flex-col justify-between">
              <div className="w-10 h-10 rounded-full bg-secondary flex items-center justify-center">
              ...
              <div>
                ...
                <p className="text-sm text-muted-foreground">
                  Book sessions with certified stylists.
                </p>
              </div>
            </div>
          </motion.div>
          ...
          <motion.div {...hoverProps} className="bento-animate bento-item lg:col-span-5 relative group overflow-hidden">
            <img src={featureCommunity} alt="Style community" className="absolute inset-0 w-full h-full object-cover opacity-25 group-hover:opacity-35 transition-opacity duration-700" />
            <div className="relative z-10 h-full flex flex-col justify-between">
              <div className="flex items-center gap-3">
                <div className="w-10 h-10 rounded-full bg-secondary flex items-center justify-center">
